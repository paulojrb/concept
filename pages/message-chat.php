                ...
                <div class="content-container">
                    <div class="chat-module">
                        <div class="chat-module-top">
                            <form action="./message-chat.php" method="GET">
                                <div class="input-group input-group-round">
                                    ...
                                    <input type="search" class="form-control filter-list-input" placeholder="Search chat for user" name="user" aria-label="Search Chat">
                                </div>
                            </form>
                            <div class="chat-module-body">
                                <?php
                                    if ( isset($_GET["user"]) ) 
                                        $result = HandlerSQL::List_Messages($_GET["user"]);
                                    else
                                        $result = HandlerSQL::List_Messages('admin');
                                ?>
                                ...
                                <div class="media chat-item">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                            <span class="chat-item-author"><?php echo $value["nick"]; ?></span>
